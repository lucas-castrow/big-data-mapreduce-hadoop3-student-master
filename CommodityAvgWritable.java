...
public class CommodityAvgWritable implements WritableComparable<CommodityAvgWritable> {
    /**
    ...
    public CommodityAvgWritable(int n, double soma) {
        this.n = n;
        this.soma = soma;
    }
    ...
    @Override
    public int compareTo(CommodityAvgWritable o) {
    ...
    public boolean equals(Object o) {
        ...
        CommodityAvgWritable that = (CommodityAvgWritable) o;
