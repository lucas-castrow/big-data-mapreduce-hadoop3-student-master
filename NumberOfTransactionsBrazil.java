...
public class NumberOfTransactionsBrazil implements WritableComparable<NumberOfTransactionsBrazil> {
    ...
    public void write(DataOutput dataOutput) throws IOException {
        dataOutput.writeUTF(pais); // MUITO CUIDADO COM A ORDEM!
        dataOutput.writeInt(valor);
    }

    @Override
    public void readFields(DataInput dataInput) throws IOException {
        pais = dataInput.readUTF(); // DEVE SEGUIR A MESMA ORDEM DA ESCRITA!
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NumberOfTransactionsBrazil)) return false;
        NumberOfTransactionsBrazil that = (NumberOfTransactionsBrazil) o;
        return valor == that.valor && Objects.equals(pais, that.pais);
    }
